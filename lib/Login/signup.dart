...
class SignUpView extends StatefulWidget {
  ...
  @override
  State<SignUpView> createState() => _NgamarSignUpViewState();
}

class _NgamarSignUpViewState extends State<SignUpView> {
  ...
  void _signUp() async {
    ...
    try {
      ...
      await _firestore
          ...
          .then((value) => showToast(message: "User added successfully!"))
          .catchError(
              (error) => showToast(message: "Failed to add user: $error"));
    } catch (e) {
            ...
            child: Column(
              children: [
                ...
                AuthField(
                  ...
                  keyboardType: TextInputType.phone, // Corrected keyboardType
                  textInputAction: TextInputAction.next,
                ),
                const SizedBox(height: 15),
                // Email Field.
